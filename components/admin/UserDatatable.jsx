  ...
  const requestSearch = (searchedVal) => {
    if(searchedVal!=""){
      const filteredRows = rows.filter((row) => {
        return (row.username.toLowerCase().includes(searchedVal.toLowerCase())||searchedVal.toLowerCase().includes(row.username.toLowerCase()))||(row.phonenumber.toLowerCase().includes(searchedVal.toLowerCase())||searchedVal.toLowerCase().includes(row.phonenumber.toLowerCase()));
      });
